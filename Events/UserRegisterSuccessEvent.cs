...
namespace IdentityServerHost.Events
{
    ...
    public class UserRegisterSuccessEvent : Event
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserRegisterSuccessEvent"/> class.
        /// </summary>
        ...
        public UserRegisterSuccessEvent(string provider, string providerUserId, string subjectId, string name, bool interactive = true, string clientId = null)
            : this()
        {
            Provider = provider;
        ...
        /// <param name="interactive">if set to <c>true</c> [interactive].</param>
        /// <param name="clientId">The client id.</param>
        public UserRegisterSuccessEvent(string username, string subjectId, string name, bool interactive = true, string clientId = null)
            : this()
        {
            Username = username;
            SubjectId = subjectId;
        ...
        /// Initializes a new instance of the <see cref="UserRegisterSuccessEvent"/> class.
        /// </summary>
        protected UserRegisterSuccessEvent()
            : base(EventCategories.Registration,
                  "User Register Success",
                  EventTypes.Success,
                  EventIds.UserRegisterSuccess)
        {
        }
